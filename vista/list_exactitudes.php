...
$filas = ExactitudControlador::getExactitudess($page);
        ...
        <div class="col-md-9 col-lg-9" style="background-color: #d4dde5; height: 100%;">
            ...
            <div class="col-md-12 col-lg-12  container-fluid">
                <div>
                    ...
                    <div class="mt-5 ml-4 col-lg-12 col-sm-12">
                        <h1 style="font-family: Champagne; font-size: 45px;" class="float-left ml-5 mt-2 text-center mb-5">Exactitudes</h1>
            ...
            <div id="datos" class="col-xl-12 col-md-12 col-lg-12 mt-5 container-fluid table-responsive">
                <table class="table table-hover">
                    ...
                    <?php foreach ($filas as $exactitud) {  ?>
                        <tr>
                            ...
                            <td><?php echo $exactitud["id_exactitud"] ?></td>
                            <td><?php echo $exactitud["Carga_exa"] ?></td>
                            <td><?php echo $exactitud["Indicacion_exa"] ?></td>
                            <td><?php echo $exactitud["Error_exa"] ?></td>
                            <td><?php echo $exactitud["id_protocolo"] ?></td>
                            <td>
                                ...
                                <a href="javascript:eliminar(confirm('Deseas eliminar?'),
                                     'eliminar_exactitud_logic.php?id_exactitud=<?php echo $exactitud["id_exactitud"]  ?>');" class="btn btn-danger  btn-sm mt-1  mr-5"><i class="fa fa-times fa-1x" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    <?php  } ?>
                    </tbody>
...
<section id="pie">
    ...
    <script src="../js/buscar_exactitud.js"></script>
</body>
