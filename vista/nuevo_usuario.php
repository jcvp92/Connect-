                ...
                <div class="encabezado container-fluid mt-5 ml-4 col-md-9 col-lg-9">
                    ...
                    <div class="ml-5">
                        <div class="ml-5">
                            ...
                            <h2 class="float-left ml-4 mb-3" style="font-family: Bahnschrift;  font-size: 45px; margin-top : 10px;">Crear usuario</h2>
                    ...
                    <div class="container-fluid mt-1">
                        ...
                        <div class=" float-left col-md-12 col-lg-12 mt-3 col-sm-12">
                            ...
                            <form class="row g-3" action="registroCode.php" method="POST" enctype="multipart/form-data">
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <span class="fa fa-id-card form-control-icon"></span>
                                        <input type="number" name="txtCedula" class="form-control" required placeholder="Identificación" id="inputEmail4">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        <span class="fa fa-address-card form-control-icon"></span>
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        <span class="fa fa-linux form-control-icon"></span>
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="txtContraseña" class="form-control" required placeholder="Contraseña" required>
                                    </div>
                                </div>
