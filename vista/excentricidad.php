...
?>
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <form name="F1" action="../logic_post/excentricidad_post.php"method="POST" >
                <div class="container-fluid">
                    <div class="row bg-danger">
                        <div class="col-md-12">
                            <h3 id="certificacion">Excentricidad</h3>
                ...
                <div class="container">
                    ...
                    <div class="form-group row shadow p-3 mb-5 bg-white rounded-0" style="border: 1px solid red">
                        ...
                        <div class="col-md-4 mt-4">
                            ...
                            <input type="text" class="form-control" name="txtCarga_exce" id="carga" onkeyup="restar1();" autocomplete="off" required autofocus placeholder="Ingrese la carga"></input>
                        </div>
                        ...
                        <div class="col-md-6  mt-4">
                            ...
                            <input type="text" class="form-control" name="txtIndi_exce1" id="indi1" onkeyup="restar1();"  autocomplete="off" required autofocus placeholder="Ingrese la carga indicación 1"></input>
                        </div>


                        <div class="col-md-6  mt-4">
                            <label for="exacti">Error (1):</label>
                            <input type="text" readonly class="form-control" name="txtError_exce1" id="error" autocomplete="off" autofocus placeholder="Ingrese el error 1"></input>
                        </div>
                        ...
                        <div class="col-md-6  mt-4">
                            ...
                            <input type="text" class="form-control" name="txtIndi_exce2" id="indi2" autocomplete="off" onkeyup="restar1();"  required autofocus placeholder="Ingrese la carga indicación 2"></input>
                        </div>


                        <div class="col-md-6  mt-4">
                            <label for="capi">Error (2):</label>
                            <input type="text"  readonly class="form-control" name="txtError_exce2" id="error2" autocomplete="off" required autofocus placeholder="Ingrese el error 2"></input>
                        </div>
                        ...
                        <div class="col-md-6  mt-4">
                            ...
                            <input type="text" class="form-control" name="txtIndi_exce3" id="indi3" onkeyup="restar1();" autocomplete="off" required autofocus placeholder="Ingrese la carga indicación 3"></input>
                        </div>


                        <div class="col-md-6  mt-4">
                            <label for="exacti">Error (3):</label>
                            <input type="text" readonly  class="form-control" name="txtError_exce3" id="error3" autocomplete="off" autofocus placeholder="Ingrese el error 3"></input>
                        </div>
                        ...
                        <div class="col-md-6  mt-4">
                            ...
                            <input type="text" class="form-control" name="txtIndi_exce4" id="indi4" onkeyup="restar1();" autocomplete="off" required autofocus placeholder="Ingrese la carga indicación 4"></input>
                        </div>


                        <div class="col-md-6  mt-4">
                            <label for="exacti">Error (4):</label>
                            <input type="text" readonly  class="form-control" name="txtError_exce4" id="error4" autocomplete="off" autofocus placeholder="Ingrese el error 4"></input>
                        </div>
                        ...
                        <div class="col-md-6  mt-4">
                            ...
                            <input type="text" class="form-control" name="txtIndi_exce5" id="indi5" onkeyup="restar1();" autocomplete="off" required autofocus placeholder="Ingrese la carga indicación 5"></input>
                        </div>


                        <div class="col-md-6  mt-4">
                            <label for="exacti">Error (5):</label>
                            <input type="text" readonly  class="form-control" name="txtError_exce5" id="error5" autocomplete="off" autofocus placeholder="Ingrese el error 5"></input>
                        </div>
        ...
        <script src="../js/excentricidad.js"></script>
