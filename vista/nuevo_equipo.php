            ...
            <div class="encabezado container-fluid mt-5 ml-4 col-md-9 col-lg-9">
                ...
                <div class="ml-5">
                    <div class="ml-5">
                        ...
                        <h2 class="float-left ml-4 mb-3" style="font-family: Bahnschrift;  font-size: 45px; margin-top : 10px;">Crear equipo</h2>
                ...
                <div class="container-fluid mt-1">
                    ...
                    <div class=" float-left col-md-12 col-lg-12 mt-3 col-sm-12">
                        ...
                        <form class="row g-3" action="registroCodeEquipo.php" method="POST">
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-id-card form-control-icon"></span>
                                    <input type="number" name="txtid_equipo" class="form-control" required placeholder="Identificación" id="inputEmail4">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtModelo" class="form-control" required placeholder="Modelo" id="Modelo">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-wrench form-control-icon"></span>
                                    <input type="text" name="txtFabricante" class="form-control" required placeholder="Fabricante" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-code form-control-icon"></span>
                                    <input type="text" name="txtSerial" class="form-control" required placeholder="Serial" id="inputEmail4">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtUbicacion" class="form-control" required placeholder="Ubicacion" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-microchip form-control-icon"></span>
                                    <input type="text" name="txtCodigo_interno" class="form-control" required placeholder="Codigo interno" required>
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-barcode form-control-icon"></span>
                                    <select class="form-select form-control" name="txtid_tipo" required aria-label="Default select example">
                                        <!-- <option selected>Sede</option> -->
                                        $filassedes = array();
                                        <?php foreach ($filassedes as $valor) {  ?>
                                            <option value=<?php echo $valor["id_tipo"]; ?>><?php echo $valor['id_tipo']; ?></option>
                                        <?php  } ?>
                                    </select>
                                </div>
                            </div>
