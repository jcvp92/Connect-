...
?>
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <form id="revision" name="revision" action="../logic_post/revision_post.php"  method="POST">
                <div class="container-fluid">
                    <div class="row bg-danger">
                        <div class="col-md-12">
                            <h3 id="certificacion">Revisión</h3>
                ...
                <div class="container">
                    ...
                    <div class="form-group row shadow p-3 mb-5 bg-white rounded-0"  style="border: 2px solid red">
                        <div class="col-md-6 mt-4">
                            <label for="observa">Observaciones:</label>
                            <textarea type="text" class="form-control" maxlength="200" name="txtObserva" id="excentre" autocomplete="off" required autofocus placeholder="Ingrese la observación"></textarea>
                        </div>
                        <div class="col-md-6 mt-4">
                            <label for="item">Item a cotizar::</label>
                            <input type="text" class="form-control" name="txtItem" id="exacti" autocomplete="off" required autofocus placeholder="Ingrese el item a cotizar"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="realizado">Realizado por:</label>
                            <input type="text" class="form-control" name="txtRealizado" id="excentre" autocomplete="off" required autofocus placeholder="Ingrese realizado por"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="revisado">Revisado por:</label>
                            <input type="text" class="form-control" name="txtRevisado" id="exacti" autocomplete="off" required autofocus placeholder="Ingrese revisado por"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="fe_revi">Fecha:</label>
                            <input type="date" class="form-control" name="txtFecha" id="exacti" autocomplete="off" required autofocus placeholder="Ingrese la fecha"></input>
                        </div>
