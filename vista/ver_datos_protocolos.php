        ...
        <div class="col-md-9 col-lg-9" style="background-color: #d4dde5; height: 70px;">
            ...
            <div class="container-fluid mt-1">
                ...
                <div class=" float-left col-md-12 col-lg-12  col-sm-12">
                    ...
                    <form class="row g-3" action="crear_protocolo_logic.php" method="POST">

                        <?php

                        if (is_null($protocolo)) { ?>
                            <h1 id="sesion" class="float-center  pl-5 mb-2" style="font-family: Champagne; margin-top : -80px;">Crear nuevo protocolo</h1>

                        <?php } else { ?>
                            <div class="ml-5">
                                <h1 style="font-family: Champagne; margin-top: -80px; font-size:45px; " id="sesion" class="d-flex justify-content-lg-center ml-5   text-dark">Datos de <?php echo $protocolo->getCodigo_pq(); ?> <?php echo $protocolo->getEsquema(); ?>
                                </h1>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="txtCodigo_pq" class="form-control" readonly value="<?= $protocolo->getCodigo_pq() ?>" placeholder="Codigo" id="inputEmail4">
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <span class="fa fa-user-circle form-control-icon"></span>
                                <input type="text" name="txtTrazabilidad" class="form-control" readonly required value="<?= $protocolo->getTrazabilidad() ?>" placeholder="Trazabilidad" id="Trazabilidad">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="txtincertidumbre" class="form-control" readonly required value="<?= $protocolo->getincertidumbre() ?>" placeholder="Incertidumbre" id="inputEmail4">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtcomentarios" class="form-control" readonly required value="<?= $protocolo->getcomentarios() ?>" placeholder="Comentarios" id="inputEmail4">
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            ...
                            <div class="form-group">
                                <span class="fa fa-phone form-control-icon"></span>
                                <input type="text" name="txtEsquema" class="form-control" readonly required value="<?= $protocolo->getEsquema() ?>" placeholder="Esquema" id="inputEmail4">
                            </div>
                        </div>
                </div>
                </form>
