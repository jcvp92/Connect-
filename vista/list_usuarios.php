        ...
        <div class="row">
            <div class="col-md-3" style="min-height: 100%; background-color: #f8fafb">
                <div class="container">
                    ...
                    <div id="Navbar2" class="d-grid gap-2 col-12 mx-auto mt-1 float-none">
                    ...
                    <div id="Navbar2" class="d-grid gap-2 col-12 mx-auto mt-1 float-none">
                        ...
                        <a href="" class="btn  btn-lg" style="font-size: 18px;"><i class="fa fa-pencil  fa-md mr-2"></i>Exactitud</a>
                    </div>
                    <div id="Navbar2" class="d-grid gap-2 col-12 mx-auto mt-1 float-none">
                ...
                <div class="col-md-12 col-lg-12  container-fluid">
                    <div>
                        ...
                        <div class="mt-5 ml-4 col-lg-12 col-sm-12">
                            <h1 style="font-family: Bahnschrift; font-size: 45px;" class="float-left ml-5 mt-2 text-center mb-5">USUARIOS</h1>
                ...
                <div id="datos" class="col-xl-12 col-md-12 col-lg-12 mt-5 container-fluid table-responsive">
                    <table class="table table-hover">
                        <thead style="background-color: #b11317; color: white">
                            <tr>
                                <th scope="col"></th>
                                <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">CEDULA </th>
                                <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">NOMBRES</th>
                                <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">APELLIDOS</th>
                                <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">CARGO</th>
                                <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">TELEFONO</th>
                                <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">TIPO</th>
                                <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">FOTO</th>
                                <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">CORREO</th>
                                <th colspan="2" scope="col"  id="colu" style="font-family: 'Arial Narrow'; text-align: -moz-left">ACCIONES</th>
                            </tr>
                        </thead>
                        <tbody class="table-striped">
                            <?php foreach ($filas as $usuario) {  ?>
                                <tr>
                                    ...
                                    <td style="font-family: Algerian; font-size: 22px"><?php echo $usuario["Cedula"] ?></td>
                                    <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $usuario["Nombres"] ?></td>
                                    <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $usuario["Apellidos"] ?></td>
                                    <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $usuario["Cargo"] ?></td>
                                    <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $usuario["Tel_usu"] ?></td>
                                    <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $usuario["Tipo_de_usuario"] ?></td>
                                    <td><img style="border-radius: 150PX; text-align: center"; width="100" src="<?php echo $usuario["Foto"]; ?>"></td>
                                    <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $usuario["correo_electronico"] ?></td>
                                    <td>
                    ...
                    <nav aria-label="navbar navbar-expand-lg navbar-dark bg-danger fixed-top">
                        <ul class="pagination justify-content-center" style="border-radius: initial">
                            <li class="page-item" style="border-radius: 250px" >
                                ...
                                <div class="col-lg-4 mt-5 col-md-12">
                                    ...
                                    <div class="collapse text-white d-lg-flex" id="Two" data-parent="#accordion">
                                        <div>
                                            ...
                                            <div>caliche_92@hotmail.com</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 mt-5 col-md-12">
