...
?>
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <form id="reg_pruebas" name="reg_pruebas" action="../logic_post/registro_prueba_post.php"  method="POST">
                <div class="container-fluid">
                    <div class="row bg-danger">
                        <div class="col-md-12">
                            <h3 id="certificacion">Registro de prueba </h3>
                ...
                <div class="container">
                    ...
                    <div class="form-group row shadow p-3 mb-5 bg-white rounded-0"  style="border: 1px solid red">
                        <div class="col-md-4 mt-4">
                            <label for="excentre">Tipo de equipo:</label>
                            <input type="text" class="form-control" name="txtTipo_equi" id="excentre" autocomplete="off" required autofocus placeholder="Ingrese el tipo de equipo"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="exacti">Fabricante:</label>
                            <input type="text" class="form-control" name="txtFabricante" id="exacti" autocomplete="off" required autofocus placeholder="Ingrese el fabricante"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="exacti">Modelo:</label>
                            <input type="text" class="form-control" name="txtModelo" id="exacti" autocomplete="off" required autofocus placeholder="Ingrese el modelo"></input>
                        </div>

                        <div class="col-md-4 mt-4">
                            <label for="exacti">Serial:</label>
                            <input type="text" class="form-control" name="txtSerial" id="exacti" autocomplete="off" required autofocus placeholder="Ingrese el serial"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="excentre">Ubicación:</label>
                            <input type="text" class="form-control" name="txtUbicacion" id="excentre" autocomplete="off" required autofocus placeholder="Ingrese la ubicación"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="exacti">Identificación:</label>
                            <input type="text" class="form-control" name="txtIdentificacion" id="exacti" autocomplete="off" required autofocus placeholder="Ingrese la identificacion"></input>
                        </div>
        ...
        <script src="../js/regis_prueba.js"></script>
    </body>
