...
$filassedes = ClienteControlador::getCliente("");
            ...
            <div class="encabezado container-fluid mt-5 ml-4 col-md-9 col-lg-9">
                ...
                <div class="container-fluid mt-1">
                    ...
                    <div class=" float-left col-md-12 col-lg-12  col-sm-12">
                        ...
                        <form class="row g-3" action="crear_cliente_logic.php" method="POST">
                            <?php
                            if (is_null($cliente)) { ?>
                            ...
                            <?php } else { ?>
                                <div class="ml-5">
                                    <h1 style="font-family: Bahnschrift; margin-top: -80px; font-size:45px; " id="sesion" class="d-flex justify-content-lg-center ml-5   text-dark">Datos de <?php echo $cliente->getNit(); ?> <?php echo $cliente->getRazon_social(); ?>
                                    </h1>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtNit" class="form-control" readonly required value="<?= $cliente->getNit() ?>" placeholder="Nit" id="Nit">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-pencil form-control-icon"></span>
                                    <input type="text" name="txtRazon_social" class="form-control" readonly required value="<?= $cliente->getRazon_social() ?>" placeholder="Razon social" id="inputEmail4">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtdireccion_cliente" class="form-control" readonly required value="<?= $cliente->getdireccion_cliente() ?>" placeholder="Direccion" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtResponsable" class="form-control" readonly required value="<?= $cliente->getResponsable() ?>" placeholder="Responsable" required>
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="txtTelefono_clien" class="form-control" readonly required placeholder="Telefono" value="<?= $cliente->getTelefono_clien() ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-whatsapp form-control-icon"></span>
                                    <input type="number" name="txtCelular_cliente" class="form-control" readonly required placeholder="Celular" value="<?= $cliente->getCelular_cliente() ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-barcode form-control-icon"></span>
                                    <input type="number" name="txtCodigo_ciudad" required readonly class="form-control" value="<?= $cliente->getCodigo_ciudad() ?>" placeholder="Codigo ciudad" required>
                                </div>
                            </div>
                        </form>
                    </div>
