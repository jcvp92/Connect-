...
$filassedes = EquiposControlador::getEquipo("");
        ...
        <div class="col-md-9 col-lg-9" style="background-color: #d4dde5; height: 70px;">
            ...
            <div class="container-fluid mt-1">
                ...
                <div class=" float-left col-md-12 col-lg-12  col-sm-12">
                    ...
                    <form class="row g-3" action="crear_equipo_logic.php" method="POST">
                        <?php

                        if (is_null($equipo)) { ?>
                            <h1 id="sesion" class="float-center  pl-5 mb-2" style="font-family: Champagne; margin-top : -80px;">Crear nuevo equipo</h1>

                        <?php } else { ?>
                            <div class="ml-5">
                                <h1 style="font-family: Champagne; margin-top: -80px; font-size:45px; " id="sesion" class="d-flex justify-content-lg-center ml-5   text-dark">Datos de <?php echo $equipo->getFabricante(); ?> <?php echo $equipo->getSerial(); ?>
                                </h1>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="txtModelo" class="form-control" readonly required value="<?= $equipo->getModelo() ?>" placeholder="Modelo" id="Modelo">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="txtFabricante" class="form-control" readonly required value="<?= $equipo->getFabricante() ?>" placeholder="Fabricante" id="inputEmail4">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtSerial" class="form-control" readonly required value="<?= $equipo->getSerial() ?>" placeholder="Serial" id="inputEmail4">
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtUbicacion" class="form-control" readonly required value="<?= $equipo->getUbicacion() ?>" placeholder="Ubicacion" required>
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <span class="fa fa-connectdevelop form-control-icon"></span>
                                <input type="number" name="txtCodigo_interno" class="form-control" readonly required placeholder="Codigo interno" value="<?= $equipo->getCodigo_interno() ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <span class="fa fa-barcode form-control-icon"></span>
                                <input type="number" name="txtid_tipo" required readonly class="form-control" value="<?= $equipo->getid_tipo() ?>" placeholder="ID" required>
                            </div>
                        </div>
                    </form>
                </div>
