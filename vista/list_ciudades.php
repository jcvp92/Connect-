...
$filas = CiudadesControlador::getCiudades($page);
            ...
            <div class="col-md-12 col-lg-12  container-fluid">
                <div>
                    ...
                    <div class="mt-5 ml-4 col-lg-12 col-sm-12">
                        <h1 style="font-family: Bahnschrift; font-size: 45px;" class="float-left ml-5 mt-2 text-center mb-5">CIUDADES</h1>
            ...
            <div id="datos" class="col-xl-12 col-md-12 col-lg-12 mt-5 container-fluid table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">UBICACIÓN</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">DEPARTAMENTOS</th>
                        <th colspan="2" scope="col" style="font-family: 'Arial Narrow'; text-align: left"  id="colu">ACCIONES</th>
                    </tr>
                    </thead>
                    <tbody class="table-striped">
                    <?php foreach ($filas as $ciudad) {  ?>
                        <tr>
                            <td> <a href="ver_datos_ciudad.php?Codigo_ciudad=<?= $ciudad["Codigo_ciudad"] ?>" class="btn btn-light btn-sm mt-1"><i class="fa fa-address-book-o" aria-hidden="true"></i></a></td>
                            <td style="font-family: Algerian; font-size: 22px; text-align: center"><?php echo $ciudad["Codigo_ciudad"] ?></td>
                            <td style="font-family: Bahnschrift; font-size: 20px; text-align: center"><?php echo $ciudad["Ubicación"] ?></td>
                            <td style="font-family: Bahnschrift; font-size: 20px; text-align: center"><?php echo $ciudad["departamentos"] ?></td>
                            <td>
                                ...
                                <a href="javascript:eliminar(confirm('Deseas eliminar este campo?'),
                                     'eliminar_ciudad_logic.php?Codigo_ciudad=<?php echo $ciudad["Codigo_ciudad"]  ?>');" class="btn btn-danger  btn-sm mt-1  mr-5"><i class="fa fa-times fa-1x" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    <?php  } ?>
                    </tbody>
...
<section id="pie">
    ...
    <script src="../js/buscar_ciudad.js"></script>
</body>
