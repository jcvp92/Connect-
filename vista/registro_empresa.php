...
?>
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <form id="registro_empresa" class="registro_empresa" action="registro_empresa_post.php" method="POST">
                <div class="container-fluid">
                    <div class="row bg-danger">
                        <div class="col-md-12">
                            <h3 id="certificacion">información de la empresa</h3>
                ...
                <div class="container">
                    ...
                    <div class="form-group row shadow p-3 mb-5 bg-white rounded-0"  style="border: 1px solid red">
                        <div class="col-md-4 mt-4">
                            <label for="Nii">Nit:</label>
                            <input type="text" class="form-control" name="txtNii" id="Nii" autocomplete="off" required autofocus placeholder="Ingrese el nit de la empresa"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="Nombre_empresa">Nombre:</label>
                            <input type="text" class="form-control" name="txtNom_emp" id="Nom_emp" autocomplete="off" required autofocus placeholder="Ingrese el nombre de la empresa"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="dir_emp">Dirección:</label>
                            <input type="text" class="form-control" name="txtDir_emp" id="dir_emp" autocomplete="off" required autofocus placeholder="Ingrese la direccion de la empresa"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="tel_emp">Telefono:</label>
                            <input type="number" class="form-control" name="txtTel_emp" id="tel_emp" autocomplete="off" required autofocus placeholder="Ingrese el telefono de la empresa"></input>
                        </div>

                        <div class="col-md-4 mt-4">
                            <label for="dir_emp">Responsable:</label>
                            <input type="text" class="form-control" name="txtRes_emp" id="dir_emp" autocomplete="off" required autofocus placeholder="Ingrese la direccion de la empresa"></input>
                        </div>

                        <div class="col-md-4 mt-4">
                            <label for="dir_emp">Ciudad:</label>
                            <input type="text" class="form-control" name="txtCiudad_emp" id="dir_emp" autocomplete="off" required autofocus placeholder="Ingrese la direccion de la empresa"></input>
                        </div>
