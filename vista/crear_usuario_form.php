                ...
                <div class="encabezado container-fluid mt-5 ml-4 col-md-9 col-lg-9">
                    ...
                    <div class="container-fluid mt-1">
                        ...
                        <div class=" float-left col-md-12 col-lg-12 col-sm-12">
                            ...
                            <form class="row g-3" id="editUser" action="crear_usuario_logic.php" method="POST" enctype="multipart/form-data">

                                <?php

                                if (is_null($usuario)) { ?>
                                    <h1 id="sesion" class="float-center  pl-5 mb-2" style="font-family: cursive; margin-top : -80px;">Crear nuevo usuario</h1>

                                <?php } else { ?>
                                    <div class="ml-5">
                                        <h1 style="font-family: Bahnschrift; margin-top: -80px; font-size:45px; " id="sesion" class="d-flex justify-content-lg-center ml-5  text-dark">Editar usuario: <?php echo $usuario->getNombres(); ?> <?php echo $usuario->getApellidos(); ?>
                                        </h1>
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="txtNombres" class="form-control" required value="<?= $usuario->getNombres() ?>" placeholder="Nombres" id="Nombres">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        <span class="fa fa-id-card form-control-icon"></span>
                                        <input type="text" name="txtApellidos" class="form-control" required value="<?= $usuario->getApellidos() ?>" placeholder="Apellidos" id="inputEmail4">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="txtCargo" class="form-control" required value="<?= $usuario->getCargo() ?>" placeholder="Cargo" id="inputEmail4">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="txtTel_usu" class="form-control" required value="<?= $usuario->getTel_usu() ?>" placeholder="Telefono" required>
                                    </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <select type="taskOption" name="txtTipo_de_usuario" id="Tipo_de_usuario" required value="<?= $usuario->getTipo_de_usuario() ?>" autofocus placeholder="Tipo_de_usuario" class="form-control">
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="txtNickname" class="form-control" required placeholder="Nickname" value="<?= $usuario->getNickname() ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="txtContraseña" class="form-control"  placeholder="Contraseña" value="<?= $usuario->getContraseña() ?>" required>
                                    </div>
                                </div>

                                <div class="col-md-6  mt-2">
                                    <div class="form-group">
                                        <span class="fa fa-image form-control-icon"></span>
                        <span class="btn btn-block btn-file">
                            Subir imagen<input id="inputFile1" name="txtFoto" type="file" <?= is_null($usuario->getFoto()) ? "required" : "" ?>>
                            <?php if(!is_null($usuario)) { ?>
                                <input type="hidden" name="txtFotoAnt" <?= !is_null($usuario->getFoto()) ? "value='{$usuario->getFoto()}'" : "" ?>>
                            <?php } ?>
                        </span>
                                </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="txtcorreo_electronico" required class="form-control" value="<?= $usuario->getCorreo_electronico() ?>" placeholder="Correo electronico" required>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <span class="fa fa-cogs form-control-icon"></span>
                                    <select class="form-select form-control" required name="txtCodigo_sede" value="<?= $usuario->getCodigo_sede() ?>" autofocus placeholder="Tipo_de_usuario" class="form-control">
                                ...
                                <div id="edit" class="justify-content-center mt-4 mb-4 d-md-table mx-auto ">
                                    ...
                                    <button type="submit" class="reg btn-lg d-flex justify-content-center d-md-table mx-auto mt-3"> <?php echo is_null($usuario) ?
                                                                                                                                        " Crear usuario " : "editar" ?></button>
                                </div>
                                </div>
