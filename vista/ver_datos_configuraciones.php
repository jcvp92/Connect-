        ...
        <div class="col-md-9 col-lg-9" style="background-color: #d4dde5; height: 70px;">
            ...
            <div class="container-fluid mt-1">
                ...
                <div class=" float-left col-md-12 col-lg-12  col-sm-12">
                    ...
                    <form class="row g-3" action="crear_configuracion_logic.php" method="POST">
                        <?php

                        if (is_null($configuracion)) { ?>
                            <h1 id="sesion" class="float-center  pl-5 mb-2" style="font-family: Champagne; margin-top : -80px;">nueva configuracion</h1>

                        <?php } else { ?>
                            <div class="ml-5">
                                <h1 style="font-family: Champagne; margin-top: -80px; font-size:45px; " id="sesion" class="d-flex justify-content-lg-center ml-5   text-dark">Datos de <?php echo $configuracion->getEstado(); ?> <?php echo $configuracion->gettipo_config(); ?>
                                </h1>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="txttipo_config" class="form-control" readonly required value="<?= $configuracion->gettipo_config() ?>" placeholder="Tipo Configuracion" id="inputEmail4">
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <span class="fa fa-comments form-control-icon"></span>
                                <textarea type="text" name="txtDescripcion_config" class="form-control" readonly required placeholder="Descripcion Configuracion" id="Descripcion_config">
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="txtEstado" class="form-control" readonly required value="<?= $configuracion->getEstado() ?>" placeholder="Estado" id="inputEmail4">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtvalor" class="form-control" readonly required value="<?= $configuracion->getvalor() ?>" placeholder="Valor" id="inputEmail4">
                            </div>
                        </div>
                     </div>
                </form>
