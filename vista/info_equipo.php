...
?>
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <form id="info_equipo" name="info_equipo" action="../logic_post/info_equi_post.php"  method="POST">
                <div class="container-fluid">
                    <div class="row bg-danger">
                        <div class="col-md-12">
                            <h3 id="certificacion">información del equipo</h3>
                ...
                <div class="container">
                    ...
                    <div class="form-group row shadow p-3 mb-5 bg-white rounded-0"  style="border: 1px solid red">
                        <div class="col-md-4 mt-4">
                            <label for="tipo_equi">Tipo de equipo:</label>
                            <input type="text" class="form-control" name="txtTipo_equi" id="tipo_equi" autocomplete="off" required autofocus placeholder="Ingrese el tipo de quipo"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="fabri_equi">Fabricante:</label>
                            <input type="text" class="form-control" name="txtFabri_equi" id="fabricante" autocomplete="off" required autofocus placeholder="Ingrese el fabricante"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="modelo_equi">Modelo:</label>
                            <input type="text" class="form-control" name="txtModelo_equi" id="modelo_equi" autocomplete="off" required autofocus placeholder="Ingrese el modelo"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="serial_equi">Serial:</label>
                            <input type="text" class="form-control" name="txtSerial_equi" id="serial_equi" autocomplete="off" required autofocus placeholder="Ingrese el serial"></input>
                        </div>

                        <div class="col-md-4 mt-4">
                            <label for="ubi_equi">Ubicación:</label>
                            <input type="text" class="form-control" name="txtUbi_equi" id="ubi_equi" autocomplete="off" required autofocus placeholder="Ingrese la ubicación"></input>
                        </div>

                        <div class="col-md-4 mt-4">
                            <label for="iden_equi">Identificación:</label>
                            <input type="text" class="form-control" name="txtIden_equi" id="iden_equi" autocomplete="off" required autofocus placeholder="Ingrese la identificación"></input>
                        </div>
        ...
        <script src="../js/info_equipo.js"></script>
    </body>
