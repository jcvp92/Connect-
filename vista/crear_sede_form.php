...
$filassedes = SedesControlador::getSede("");

$cliente = null;

if (isset($_GET["Codigo_sede"])) {
    $Cliente = ($_GET["Codigo_sede"]);
    $cliente = SedesControlador::editarSede($Cliente);
}
?>
            ...
            <div class="encabezado container-fluid mt-5 ml-4 col-md-9 col-lg-9">
                ...
                <div class="container-fluid mt-1">
                    ...
                    <div class=" float-left col-md-12 col-lg-12 col-sm-12">
                        ...
                        <form class="row g-3" id="editUser" action="crear_sede_logic.php" method="POST" enctype="multipart/form-data">

                            <?php

                            if (is_null($cliente)) { ?>
                                <h1 id="sesion" class="float-center  pl-5 mb-2" style="font-family: Bahnschrift; margin-top : -80px;">Crear nueva sede</h1>

                            <?php } else { ?>
                                <div class="ml-5">
                                    <h1 style="font-family: Bahnschrift; margin-top: -80px; font-size:45px; " id="sesion" class="d-flex justify-content-lg-center ml-5  text-dark">Editar : <?=$cliente->getNombre(); ?>
                                    </h1>
                                    <input type="hidden" name="Codigo_sede" value="<?=$cliente->getCodigo_sede(); ?>">
                                </div>
                            <?php } ?>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-id-card form-control-icon"></span>
                                    <input type="number" name="txtCodigo_sede" class="form-control" readonly value="<?=$cliente->getCodigo_sede() ?>" placeholder="Identificación" id="inputEmail4">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtNombre" class="form-control" required value="<?=$cliente->getNombre() ?>" placeholder="Nombre" id="Nombre">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtDireccion" class="form-control" required value="<?=$cliente->getDireccion() ?>" placeholder="Direccion" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-phone form-control-icon"></span>
                                    <input type="number" name="txtTelefono" class="form-control" required value="<?= $cliente->getTelefono() ?>" placeholder="Telefono" required>
                                </div>
                            </div>
