...
$filas = EquiposControlador::getEquipo($page);
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-9" style="background-color: #d4dde5; height: 100%;">
            <div id="Navbar1" class="navbar ml-5">
                <div class="ml-5">
                    <a class="navbar-brand nav-link mt-1 ml-5 float-left" href="../vista/nuevo_equipo.php">Nuevo</a>
                    <a class="navbar-brand nav-link mt-1 ml-4" href="../vista/list_equipos.php">Lista</a>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-12  container-fluid">
                <div>
                    ...
                    <div class="mt-5 ml-4 col-lg-12 col-sm-12">
                        <h1 style="font-family: Bahnschrift; font-size: 45px;" class="float-left ml-5 mt-2 text-center mb-5">EQUIPOS</h1>
            ...
            <div id="datos" class="col-xl-12 col-md-12 col-lg-12 mt-5 container-fluid table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        <th scope="col"></th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; font-size: 20px; text-align: center"> ID </th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; font-size: 20px; text-align: center">MODELO</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; font-size: 20px; text-align: center">FABRICANTE</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; font-size: 20px; text-align: center">SERIAL</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; font-size: 20px; text-align: center">UBICACIÓN</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; font-size: 20px; text-align: center">CODIGO INTERNO</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; font-size: 20px; text-align: center">ID TIPO</th>
                        <th colspan="2" scope="col"  id="colu" style="font-family: 'Arial Narrow'; font-size: 20px; text-align: left">ACCIONES</th>
                    </tr>
                    </thead>
                    <tbody class="table-striped">
                    <?php foreach ($filas as $equipo) {  ?>
                        <tr>
                            ...
                            <td style="font-family: Algerian    light; font-size: 22px; text-align: center"><?php echo $equipo["id_equipo"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $equipo["Modelo"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $equipo["Fabricante"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $equipo["Serial"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $equipo["Ubicación"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $equipo["Codigo_interno"] ?></td>
                            <td style="font-family: Algerian light; font-size: 22px; text-align: center"><?php echo $equipo["id_tipo"] ?></td>
                            <td>
                                ...
                                <a href="javascript:eliminar(confirm('Deseas eliminar este equipo?'),
                                     'eliminar_equipo_logic.php?id_equipo=<?php echo $equipo["id_equipo"]  ?>');" class="btn btn-danger  btn-sm mt-1  mr-5"><i class="fa fa-times fa-1x" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    <?php  } ?>
                    </tbody>
