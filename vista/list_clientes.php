...
$filas = ClienteControlador::getCliente($page);
        ...
        <div class="col-md-9 col-lg-9" style="background-color: #d4dde5; height: 100%;">
            ...
            <div class="col-md-12 col-lg-12  container-fluid">
                <div>
                    ...
                    <div class="mt-5 ml-4 col-lg-12 col-sm-12">
                        <h1 style="font-family: Bahnschrift; font-size: 45px;" class="float-left ml-5 mt-2 text-center mb-5">CLIENTES</h1>
            ...
            <div id="datos" class="col-xl-12 col-md-12 col-lg-12 mt-5 container-fluid table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        <th scope="col"></th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center"> ID </th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">NIT</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">RAZON SOCIAL</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">DIRECCIÓN</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">RESPONZABLE</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">TELEFONO</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">CELULAR</th>
                        <th scope="col" id="colu" style="font-family: 'Arial Narrow'; text-align: center">CODIGO CIUDAD</th>
                    ...
                    <?php foreach ($filas as $cliente) {  ?>
                        <tr>
                            ...
                            <td style="font-family: Algerian light; font-size: 22px; text-align: center"><?php echo $cliente["id_cliente"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $cliente["Nit"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $cliente["Razon_social"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $cliente["dirección_cliente"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $cliente["Responsable"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $cliente["Telefono_clien"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $cliente["Celular_cliente"] ?></td>
                            <td style="font-family: Algerian light; font-size: 20px; text-align: center"><?php echo $cliente["Codigo_ciudad"] ?></td>
                            <td>
                                ...
                                <a href="javascript:eliminar(confirm('Deseas eliminar este cliente?'),
                                     'eliminar_cliente_logic.php?id_cliente=<?php echo $cliente["id_cliente"]  ?>');" class="btn btn-danger  btn-sm mt-1  mr-5"><i class="fa fa-times fa-1x" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    <?php  } ?>
                    </tbody>
