            ...
            <div class="encabezado container-fluid mt-5 ml-4 col-md-9 col-lg-9">
                ...
                <div class="ml-5">
                    ...
                    <div class="ml-5">
                        ...
                        <h2 class="float-left ml-4 mb-3" style="font-family: Champagne;  font-size: 45px; margin-top : 10px;">Crear Protocolo</h2>
                ...
                <div class="container-fluid mt-1">
                    ...
                    <div class=" float-left col-md-12 col-lg-12 mt-3 col-sm-12">
                        ...
                        <form class="row g-3" action="registroCodeProtocolo.php" method="POST">
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-id-card form-control-icon"></span>
                                    <input type="number" name="txtid_protocolo" class="form-control" required placeholder="Identificación" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtCodigo_pq" class="form-control" required placeholder="Codigo" id="Codigo_pq">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">

                                <div class="form-group">
                                    <span class="fa fa-book form-control-icon"></span>
                                    <input type="text" name="txtTrazabilidad" class="form-control" required placeholder="Trazabilidad" id="inputEmail4">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="form-group">
                                    <span class="fa fa-question-circle form-control-icon"></span>
                                    <input type="text" name="txtincertidumbre" class="form-control" required placeholder="Incertidumbre" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">

                                <div class="form-group">
                                    <span class="fa fa-comment form-control-icon"></span>
                                    <input type="text" name="txtcomentarios" class="form-control" required placeholder="Comentarios" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">

                                <div class="form-group">
                                    <span class="fa fa-columns form-control-icon"></span>
                                    <input type="text" name="txtEsquema" class="form-control" required placeholder="Esquema" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                            </div>
