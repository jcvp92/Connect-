...
$filassedes = ExactitudControlador::getExactitudess("");
        ...
        <div class="col-md-9 col-lg-9" style="background-color: #d4dde5; height: 70px;">
            ...
            <div class="container-fluid mt-1">
                <div class=" float-left col-md-12 col-lg-12  col-sm-12">
                    ...
                    <form class="row g-3" action="crear_exactitud_logic.php" method="POST">
                        <?php
                        ...
                        <?php } else { ?>
                            <div class="ml-5">
                                <h1 style="font-family: Champagne; margin-top: -80px; font-size:45px; " id="sesion" class="d-flex justify-content-lg-center ml-5   text-dark">Datos de <?php echo $exactitud->getCarga_exa(); ?> <?php echo $exactitud->getindicacion_exa(); ?>
                                </h1>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="txtCarga_exa" class="form-control" readonly required value="<?= $exactitud->getCarga_exa() ?>" placeholder="Carga exactitud" id="Carga_exa">
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <span class="fa fa-pencil form-control-icon"></span>
                                <input type="text" name="txtindicacion_exa" class="form-control" readonly required value="<?= $exactitud->getindicacion_exa() ?>" placeholder="Indicacion exactitud" id="inputEmail4">
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtError_exa" class="form-control" readonly required value="<?= $exactitud->getError_exa() ?>" placeholder="Error exactitud" id="inputEmail4">
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <span class="fa fa-barcode form-control-icon"></span>
                                <input type="number" name="txtid_protocolo" required readonly class="form-control" value="<?= $exactitud->getid_protocolo() ?>" placeholder="id protocolo" required>
                            </div>
                        </div>
                    </form>
                </div>
