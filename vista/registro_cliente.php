...
<div class="row">
    <div class="col-md-4 button-container">
        <div class="contenedor">
            ...
            <a href="../vista/registro_cliente.php" class="btn1">Registrarse</a>
        </div>
    </div>
            ...
            <form class="row g-3" action="registroCodeCliente.php" method="POST">
                <div class="col-md-6 mt-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="txtid_cliente" class="form-control" placeholder="ID" required id="inputEmail4">
                    </div>
                </div>
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <div class="form-group">
                        <span class="fa fa-id-card form-control-icon"></span>
                        <input type="text" name="txtRazon_social" required class="form-control" placeholder="Razon social" id="inputEmail4">
                    </div>
                </div>
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="txtdireccion_cliente" required class="form-control" placeholder="Direccion" id="inputEmail4">
                    </div>
                </div>
                ...
                <div class="col-md-6 mt-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="txtResponsable" required class="form-control" placeholder="Responsable" required>
                    </div>
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="txtTelefono_clien" required class="form-control" placeholder="Telefono" required>
                    </div>
                </div>
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="txtCelular_cliente" required class="form-control" placeholder="Celular" required>
                    </div>
                </div>
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="txtCodigo_ciudad" required class="form-control" placeholder="Codigo" required>
                    </div>
                </div>
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <select class="form-select form-control" required name="txtCodigo_ciudad" aria-label="Default select example">


                        <?php foreach ($filassedes as $valor) {  ?>


                            <option value=<?php echo $valor["Codigo_ciudad"]; ?>><?php echo $valor['id_cliente']; ?></option>
