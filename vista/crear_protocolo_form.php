...
$filassedes = ProtocolosControlador::getProtocolos("");

$protocolo = null;

if (isset($_GET["id_protocolo"])) {
    $Protocolo = ($_GET["id_protocolo"]);
    $protocolo = ProtocolosControlador::editarProtocolos($Protocolo);
}
?>
<div class="container-fluid  p-0">
    ...
    <div class="row">
        <div class="col-md-3" style="height: 900px; background-color: #f8fafb">
            <div class="container">
                <h3 style="font-family: Bahnschrift" class="text-center mt-3">Administrador</h3>
                <hr>
                <div class="mt-5">
        ...
        <div class="col-md-9 col-lg-9" style="background-color: #d4dde5; height: 70px;">
            <div id="Navbar1" class="navbar ml-5">
                <div class="ml-5">
                    <a class="navbar-brand nav-link mt-1 ml-5 float-left" href="../vista/nuevo_protocolo.php">Nuevo</a>
                    <a class="navbar-brand nav-link mt-1 ml-4" href="../vista/list_protocolos.php">Lista</a>
                </div>
            </div>
            <div class="encabezado container-fluid mt-5 ml-4 col-md-9 col-lg-9">
                ...
                <div class="container-fluid mt-1">
                    ...
                    <div class=" float-left col-md-12 col-lg-12 col-sm-12">
                        ...
                        <form class="row g-3" id="editUser" action="crear_protocolo_logic.php" method="POST" enctype="multipart/form-data">

                            <?php

                            if (is_null($protocolo)) { ?>
                                <h1 id="sesion" class="float-center  pl-5 mb-2" style="font-family: Champagne; margin-top : -80px;">Crear nueva sede</h1>

                            <?php } else { ?>
                                <div class="ml-5">
                                    <h1 style="font-family: Champagne; margin-top: -80px; font-size:45px; " id="sesion" class="d-flex justify-content-lg-center ml-5  text-dark">editar <?=$protocolo->getEsquema(); ?>
                                    </h1>
                                    <input type="hidden" name="id_protocolo" value="<?=$protocolo->getid_protocolo(); ?>">
                                </div>
                            <?php } ?>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-id-card form-control-icon"></span>
                                    <input type="number" name="txtid_protocolo" class="form-control" readonly value="<?=$protocolo->getid_protocolo() ?>" placeholder="Identificación" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-id-badge form-control-icon"></span>
                                    <input type="text" name="txtCodigo_pq" class="form-control" required value="<?=$protocolo->getCodigo_pq() ?>" placeholder="Codigo" id="Codigo_pq">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-street-view form-control-icon"></span>
                                    <input type="text" name="txtTrazabilidad" class="form-control" required value="<?=$protocolo->getTrazabilidad() ?>" placeholder="Trazabilidad" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-phone form-control-icon"></span>
                                    <input type="text" name="txtincertidumbre" class="form-control"  value="<?= $protocolo->getincertidumbre() ?>" placeholder="Incertidumbre" required>
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-phone form-control-icon"></span>
                                    <input type="text" name="txtcomentarios" class="form-control"  value="<?= $protocolo->getcomentarios() ?>" placeholder="Comentarios" required>
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-phone form-control-icon"></span>
                                    <input type="text" name="txtEsquema" class="form-control"  value="<?= $protocolo->getEsquema() ?>" placeholder="Esquema" required>
                                </div>
                            </div>
                            <div id="edit" class="justify-content-center mt-4 mb-4 d-md-table mx-auto ">
                                <div class="form-group">
                                    <span class="fa fa-cog form-control-icon"></span>
                                    <button type="submit" class="reg btn-lg d-flex justify-content-center d-md-table mx-auto mt-3"> <?php echo is_null($Protocolo) ?
                                            " Crear protocolo " : "editar" ?></button>
                                </div>
                            </div>
                        </form>
