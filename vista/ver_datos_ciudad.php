...
if (isset($_GET["Codigo_ciudad"])) {
    ...
    $ciudad = CiudadesControlador::editarCiudad($ciudad);
}
?>
            ...
            <div class="container-fluid mt-1">
                ...
                <div class=" float-left col-md-12 col-lg-12  col-sm-12">
                    ...
                    <form class="row g-3" action="crear_sede_logic.php" method="POST">
                        ...
                        if (is_null($ciudad)) { ?>
                            <h1 id="sesion" class="float-center  pl-5 mb-2" style="font-family: Champagne; margin-top : -80px;">Crear ciudad</h1>

                        <?php } else { ?>
                            <div class="ml-5">
                                <h1 style="font-family: Champagne; margin-top: -80px; font-size:45px; " id="sesion" class="d-flex justify-content-lg-center ml-5   text-dark">Datos de <?php echo $ciudad->getCodigo_ciudad(); ?>
                                </h1>
                                <input type="hidden" name="Codigo_ciudad" value="<?=$ciudad->getCodigo_ciudad(); ?>">
                            </div>
                        <?php } ?>
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <span class="fa fa-id-card form-control-icon"></span>
                                <input type="number" name="txtCodigo_ciudad" class="form-control" readonly value="<?= $ciudad->getCodigo_ciudad() ?>" placeholder="Identificación" id="inputEmail4">
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <span class="fa fa-map-marker form-control-icon"></span>
                                <input type="text" name="txtUbicacion" class="form-control" readonly required value="<?= $ciudad->getUbicacion() ?>" placeholder="Ubicacion" id="Ubicacion">
                            </div>
                        </div>

                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <span class="fa fa-map form-control-icon"></span>
                                <input type="text" name="txtdepartamentos" class="form-control" readonly required value="<?= $ciudad->getdepartamentos() ?>" placeholder="Departamentos" id="inputEmail4">
                            </div>
                        </div>
                    </div>
                </form>
