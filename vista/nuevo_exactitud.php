    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-9" style="background-color: #d4dde5; height: 70px;">
            ...
            <div class="encabezado container-fluid mt-5 ml-4 col-md-9 col-lg-9">
                ...
                <div class="ml-5">
                    <div class="ml-5">
                        <h2 class="float-left ml-4 mb-3" style="font-family: Champagne;  font-size: 45px; margin-top : 10px;">Crear exactitud</h2>
                    </div>
                </div>
                <div class="container-fluid mt-1">
                    ...
                    <div class=" float-left col-md-12 col-lg-12 mt-3 col-sm-12">
                        ...
                        <form class="row g-3" action="registroCodeExactitud.php" method="POST">
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-id-card form-control-icon"></span>
                                    <input type="number" name="txtid_exactitud" class="form-control" required placeholder="Identificación" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-industry form-control-icon"></span>
                                    <input type="text" name="txtCarga_exa" class="form-control" required placeholder="Carga Exactitud" id="Carga_exa">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-address-book form-control-icon"></span>
                                    <input type="text" name="txtindicacion_exa" class="form-control" required placeholder="Indicacion Exactitud" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-street-view form-control-icon"></span>
                                    <input type="text" name="txtError_exa" class="form-control" required placeholder="Error Exactitud" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <span class="fa fa-barcode form-control-icon"></span>
                                    <select class="form-select form-control" name="txtid_protocolo" required aria-label="Default select example">
