...
$filas = ProtocolosControlador::getProtocolos($page);
        ...
        <div class="col-md-9 col-lg-9" style="background-color: #d4dde5; height: 100%;">
            ...
            <div class="col-md-12 col-lg-12  container-fluid">
                <div>
                    ...
                    <div class="mt-5 ml-4 col-lg-12 col-sm-12">
                        <h1 style="font-family: Bahnschrift; font-size: 45px;" class="float-left ml-5 mt-2 text-center mb-5">PROTOCOLOS</h1>
            ...
            <div id="datos" class="col-xl-12 col-md-12 col-lg-12 mt-5 container-fluid table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        <th scope="col"></th>
                        <th scope="col" id="colu" style="font-family: Bahnschrift; font-size: 22px; text-align: center"> ID </th>
                        <th scope="col" id="colu" style="font-family: Bahnschrift; font-size: 20px; text-align: center">CODIGO</th>
                        <th scope="col" id="colu" style="font-family: Bahnschrift; font-size: 20px; text-align: center">TRAZABILDAD</th>
                        <th scope="col" id="colu" style="font-family: Bahnschrift; font-size: 20px; text-align: center">INCERTIDRUMBRE</th>
                    ...
                    <?php foreach ($filas as $protocolo) {  ?>
                        <tr>
                            ...
                            <td style="font-family: Algerian light; font-size: 20px; text-align: center"><?php echo $protocolo["id_protocolo"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $protocolo["Codigo_pq"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $protocolo["Trazabilidad"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $protocolo["Incertidumbre"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $protocolo["comentarios"] ?></td>
                            <td style="font-family: Bahnschrift light; font-size: 20px; text-align: center"><?php echo $protocolo["Esquema"] ?></td>
                            <td>
                                ...
                                <a href="javascript:eliminar(confirm('Deseas eliminar este protocolo?'),
                                     'eliminar_protocolo_logic.php?id_protocolo=<?php echo $protocolo["id_protocolo"]  ?>');" class="btn btn-danger  btn-sm mt-1  mr-5"><i class="fa fa-times fa-1x" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    <?php  } ?>
                    </tbody>
...
<section id="pie">
    ...
    <script src="../js/buscar_protocolo.js"></script>
</body>
