...
if (isset($_GET["Codigo_sede"])) {
    ...
    $sede = SedesControlador::editarSede($Sede);
}
        ...
        <div class="col-md-9 col-lg-9" style="background-color: #d4dde5; height: 70px;">
            ...
            <div class="container-fluid mt-1">
                ...
                <div class=" float-left col-md-12 col-lg-12  col-sm-12">
                    ...
                    <form class="row g-3" action="crear_sede_logic.php" method="POST">

                        <?php

                        if (is_null($sede)) { ?>
                            <h1 id="sesion" class="float-center  pl-5 mb-2" style="font-family: Champagne; margin-top : -80px;">Crear nuevo sede</h1>

                        <?php } else { ?>
                            <div class="ml-5">
                                <h1 style="font-family: Champagne; margin-top: -80px; font-size:45px; " id="sesion" class="d-flex justify-content-lg-center ml-5   text-dark">Datos de <?php echo $sede->getNombre(); ?> <?php echo $sede->getTelefono(); ?>
                                </h1>
                                <input type="hidden" name="Codigo_sede" value="<?=$sede->getCodigo_sede(); ?>">
                            </div>
                        <?php } ?>
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <span class="fa fa-id-card form-control-icon"></span>
                                <input type="number" name="txtCodigo_sede" class="form-control" readonly value="<?= $sede->getCodigo_sede() ?>" placeholder="Identificación" id="inputEmail4">
                            </div>
                        </div>
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                <span class="fa fa-user-circle form-control-icon"></span>
                                <input type="text" name="txtNombre" class="form-control" readonly required value="<?= $sede->getNombre() ?>" placeholder="Nombre" id="Nombre">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="txtDireccion" class="form-control" readonly required value="<?= $sede->getDireccion() ?>" placeholder="Direccion" id="inputEmail4">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtTelefono" class="form-control" readonly required value="<?= $sede->getTelefono() ?>" placeholder="Telefono" id="inputEmail4">
                            </div>
                        </div>
                        </div>
                    </form>
