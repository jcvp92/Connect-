...
?>
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <form id="veri_iinicial" name="veri_iinicial" action="../logic_post/medicion_electri_post.php"  method="POST">
                <div class="container-fluid">
                    <div class="row bg-danger">
                        <div class="col-md-12">
                            <h3 id="certificacion">Medicciones electricas</h3>
                ...
                <div class="container">
                    ...
                    <div class="form-group row shadow p-3 mb-5 bg-white rounded-0"  style="border: 1px solid red">
                        <div class="col-md-4 mt-4">
                            <label for="excentre">Vfase_neutro:</label>
                            <input type="text" class="form-control" name="txtVfase_neutro" id="excentre" autocomplete="off" required autofocus placeholder="Ingrese el Vfase_neutro"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="exacti">Vfase_tierra:</label>
                            <input type="text" class="form-control" name="txtVfase_tierra" id="exacti" autocomplete="off" required autofocus placeholder="Ingrese el Vfase_tierra"></input>
                        </div>
                        <div class="col-md-4 mt-4">
                            <label for="exacti">Vneutro_tierra:</label>
                            <input type="text" class="form-control" name="txtVneutro_tierra" id="exacti" autocomplete="off" required autofocus placeholder="Ingrese el Vneutro_tierra"></input>
                        </div>
        ...
        <script src="../js/medi_ele.js"></script>
    </body>
