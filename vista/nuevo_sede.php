            ...
            <div class="encabezado container-fluid mt-5 ml-4 col-md-9 col-lg-9">
                ...
                <div class="ml-5">
                    ...
                    <div class="ml-5">
                        ...
                        <h2 class="float-left ml-4 mb-3" style="font-family: Bahnschrift;  font-size: 45px; margin-top : 10px;">Crear sede</h2>
                        ...
                        <form class="row g-3" action="registroCodeSede.php" method="POST">
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="txtCodigo_sede" class="form-control" required placeholder="Identificación" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtDireccion" class="form-control" required placeholder="Dirección" id="inputEmail4">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="form-group">
                                    <span class="fa fa-tty form-control-icon"></span>
                                    <input type="text" name="txtTelefono" class="form-control" required placeholder="Telefono" id="inputEmail4">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                            </div>
